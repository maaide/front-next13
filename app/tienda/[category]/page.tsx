...
export async function generateMetadata({
  ...
  return {
    title: category.titleSeo && category.titleSeo !== '' ? category.titleSeo : category.category,
    description: category.descriptionSeo && category.descriptionSeo !== '' ? category.descriptionSeo : `Aquí encontraras los productos de la categoria ${category.category}`,
    openGraph: {
      title: category.titleSeo && category.titleSeo !== '' ? category.titleSeo : category.category,
      description: category.descriptionSeo && category.descriptionSeo !== '' ? category.descriptionSeo : `Aquí encontraras los productos de la categoria ${category.category}`,
