...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: design.blog.metaTitle !== '' ? design.blog.metaTitle : 'Blog',
    description: design.blog.metaDescription !== '' ? design.blog.metaDescription : 'Esta es la pagina de blog de mi tienda',
    openGraph: {
      title: design.blog.metaTitle !== '' ? design.blog.metaTitle : 'Blog',
      description: design.blog.metaDescription !== '' ? design.blog.metaDescription : 'Esta es la pagina de blog de mi tienda',
    }
